package com.collage.pnuapplication.preferences;
...
public class Preferences {
    ...
    public Boolean langSelected(Context context)
    {
        SharedPreferences sharedPreferences = context.getSharedPreferences("langPref",Context.MODE_PRIVATE);
